...
public class FileBackedTaskManager extends InMemoryTaskManager {
    ...
    public static FileBackedTaskManager loadFromFile(File file) {
        ...
        try {
            ...
            // Если только заголовок или пустые строки - возвращаем пустой менеджер
            if (lines.length <= 1) {
                return manager;
            }
            ...
            for (int i = 1; i < lines.length; i++) {
                ...
                if (task instanceof Epic) {
                    ...
                    // Обновляем счетчик ID если нужно
            ...
            // После загрузки всех задач пересчитываем статусы эпиков
